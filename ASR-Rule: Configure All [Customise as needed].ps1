...
# Uncomment the audit (first line) or enforced (second) line for each rule to quickly get your ASR rules up and running. (Run as administrator). 

# Templates:
# [AUDIT] Add-MpPreference -AttackSurfaceReductionRules_Ids <rule ID> -AttackSurfaceReductionRules_Actions AuditMode
# [ENFORCE] Set-MpPreference -AttackSurfaceReductionRules_Ids <rule ID> -AttackSurfaceReductionRules_Actions Enabled
